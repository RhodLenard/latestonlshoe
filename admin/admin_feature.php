...
if (isset($_POST['stockin'])) {
    ...
    echo "<script>alert('Stock added successfully and sizes updated!'); window.location = 'admin_feature.php';</script>";
    exit();
}
...
<body>
    ...
    <div class="main-content" style="padding: 60px 20px;">
        ...
        <div class="alert text-center mb-4" style="border-bottom: 2px solid #ccc;">
            <h2 style="font-size: 1.5rem; font-weight: bold;">Features</h2>
        </div>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <div class="d-flex flex-wrap justify-content-center gap-1">
                                    ...
                                    <a href='admin_feature.php?delete_id=<?php echo $id; ?>' class='btn btn-danger btn-sm' onclick="return confirm('Are you sure you want to delete this product?');">
        ...
        <div class="modal fade" id="stockOutModal" tabindex="-1" aria-labelledby="stockOutModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="admin_feature.php">
