...
if (isset($_POST['stockin'])) {
    ...
    echo "<script>alert('Stock added successfully and sizes updated!'); window.location = 'admin_football.php';</script>";
    exit();
}
...
if (isset($_POST['stockout'])) {
    ...
    echo "<script>alert('Stock updated successfully!'); window.location = 'admin_football.php';</script>";
    exit();
}
...
<body>
    ...
    <div class="main-content" style="padding: 60px 20px;">
        ...
        <div class="alert text-center mb-4" style="border-bottom: 2px solid #ccc;">
            <h2 style="font-size: 1.5rem; font-weight: bold;">Sneakers</h2>
        </div>
