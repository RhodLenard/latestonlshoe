...
if (isset($_POST['stockin'])) {
    ...
    echo "<script>alert('Stock added successfully and sizes updated!'); window.location = 'admin_running.php';</script>";
    exit();
}
...
if (isset($_POST['stockout'])) {
    ...
    echo "<script>alert('Stock updated successfully!'); window.location = 'admin_running.php';</script>";
    exit();
}
...
if (isset($_GET['delete_id'])) {
    ...
    echo "<script>alert('Product deleted successfully!'); window.location = 'admin_running.php';</script>";
    exit();
}
?>
...
<body>
    ...
    <div class="main-content" style="padding: 60px 20px;">
        ...
        <div class="alert text-center mb-4" style="border-bottom: 2px solid #ccc;">
            <h2 style="font-size: 1.5rem; font-weight: bold;">Running</h2>
        </div>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <div class="d-flex flex-wrap justify-content-center gap-1">
                                    ...
                                    <a href='admin_running.php?delete_id=<?php echo $id; ?>' class='btn btn-danger btn-sm' onclick="return confirm('Are you sure you want to delete this product?');">
        ...
        <div class="modal fade" id="stockOutModal" tabindex="-1" aria-labelledby="stockOutModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="admin_running.php">
